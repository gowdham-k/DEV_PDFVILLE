...
export default function UnlockPdfPage() {
  ...
  const handleSubmit = async () => {
    if (files.length === 0) {
      alert("Please select at least 1 PDF file to unlock");
      return;
    }
    ...
    try {
      ...
      a.href = url;
      a.download = files.length === 1 ? `unlocked_${files[0].name}` : "unlocked_pdfs.zip";
      a.click();
    ...
    <div style={styles.container}>
      ...
      <div style={styles.maxWidth}>
        ...
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>Unlock PDF</h1>
          <p style={styles.subtitle}>Remove password protection from your PDF documents</p>
        </div>

        <div style={styles.card}>
          <div style={styles.section}>
            <div style={styles.instructions}>
              <h3 style={styles.instructionTitle}>🔓 How to Unlock PDFs:</h3>
              <ul style={styles.instructionList}>
                <li>Select or drop password-protected PDF files</li>
                <li>Enter the password if you know it (optional - we'll try common passwords)</li>
                <li>Click "Unlock PDFs" to remove password protection</li>
                <li>Download the unlocked PDFs automatically</li>
              </ul>
            </div>
            ...
            >
              ...
              <p style={styles.uploadSubtext}>
                Select password-protected PDF files to unlock
              </p>
            </div>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.passwordSettings}>
              <label style={styles.settingLabel}>Password (Optional)</label>
              ...
              <div style={styles.noteText}>
                If you don't know the password, we'll try common passwords automatically.
                This works for many PDFs with simple passwords.
              </div>
            </div>
          </div>
          ...
          <div style={styles.actionSection}>
            ...
            {files.length === 0 && (
              <p style={{ color: '#666', marginTop: '12px' }}>
                Please select PDF files to unlock
              </p>
            )}
          </div>
        </div>
